                ...
                {jobs && jobs.map((job) => (
                    <Accordion>
                        ...
                        <AccordionDetails>
                            ...
                            {job.scripts && job.scripts.map((script: any) => (
                                <>
                                    <h1>{script.id}: {script.name}</h1>
                                    {(() => {
                                        if (script.params && script.params.length !== 0 && script.params !== "{}") {
                                            return <>
                                                ...
                                                {renderParamsInput(script.params, ((paramName: string, value: any) => {
                                                    const inputToUpdateIndex = inputs.findIndex(input => input.id === job.id);
